...
public class CustomerListActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener {
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapter = new CustomerListAdapter(this, customerDetails,userName);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(CustomerListActivity.this, HomeScreenActivity.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (id == R.id.logout) {
            Intent intent = new Intent(CustomerListActivity.this, CheckLoginActivity.class);
            startActivity(intent);
        }
        if (id == R.id.stockList) {
            Intent intent = new Intent(CustomerListActivity.this, ScreenStock.class);
            intent.putExtra("userName",userName);
            startActivity(intent);
        }
        if (id == R.id.orderBooking) {
            Intent intent = new Intent(CustomerListActivity.this, BookingCustomerListActivity.class);
            intent.putExtra("userName",userName);
            startActivity(intent);
        }
